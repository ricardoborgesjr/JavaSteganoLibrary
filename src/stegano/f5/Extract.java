...
public class Extract {
    ...
    public static void extract(File carrierImage, File embFileName, String password) {

	try {
	    carrier = new byte[(int)carrierImage.length()];
	    FileInputStream fis = new FileInputStream(carrierImage);
	    fos = new FileOutputStream(new File(embFileName.getAbsolutePath().toString()));
	    fis.read(carrier);
